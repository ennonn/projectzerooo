...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2024 at 04:42 AM
...
ALTER TABLE `order_item`
  ...
  ADD CONSTRAINT `order_item_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`),
...
ALTER TABLE `payment_table`
  ...
  ADD CONSTRAINT `payment_table_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
COMMIT;
